...
public abstract class RavenDbProjection<T>: IProjection where T: IReadModel {
    ...
    protected Task UpdateSingle(Guid id, Action<T> update) => UsingSession(session => UpdateItem(session, id, update));
